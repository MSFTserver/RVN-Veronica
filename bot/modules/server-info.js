...
exports.serverstats = {
  ...
  process: function(bot, msg, suffix) {
    ...
    if (!inSpam(msg)) {
      msg.channel.send("Please use <#" + channelID + "> to talk to stats bot.");
      return;
    }
    if (hasPerms(msg)) {
      var data = msg.guild;
      ...
      if (!Verification) {
        ...
        Verification =
          "Verified email also have been a member longer than 5min";
      } else if (Verification === 3) {
        Verification =
          "Verified email also have been a member longer than 10min";
