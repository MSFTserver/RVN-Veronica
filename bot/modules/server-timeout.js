...
exports.timeout = {
  ...
  description:
    ':desktop: :cop: puts a user in timeout for specified amount of minutes :cop: :desktop:',
    ...
    function findProfile(bot, msg, gotProfile) {
      if (!gotProfile) {
        ...
        bot.channels
          ...
          .send(
            '[' +
              timestamp.tz('America/Los_Angeles').format('MM-DD-YYYY hh:mm a') +
              ' PST][' +
              pm2Name +
              '] ' +
              msg.author.username +
