...
exports.djsdocs = {
  ...
  process: async function(bot, msg, suffix) {
    if (!inSpam(msg)) {
      msg.channel.send(
        'Please use <#' + channelID + '> to talk to d.js docs bot.'
      );
      return;
    }
    query = suffix
    		...
    		if (!embed) {
    			return msg.channel.reply("Veronica couldn't find the requested information. Maybe look for something that actually exists the next time!");
    		}
